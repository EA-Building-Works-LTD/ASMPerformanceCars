...
export default async function BlogPage() {
  ...
  return (
    <Layout>
                ...
                <div className="bg-gradient-to-br from-zinc-50 to-white border border-zinc-200 p-6 rounded-2xl shadow-md">
                  ...
                  <div className="grid gap-4">
                    ...
                    {posts
                      ...
                      .slice(0, 5) // Always get the 5 shortest posts, regardless of featured status
                      .map((post: BlogPost) => (
                        <Link
                        ...
                        >
                          <div className="bg-white border border-zinc-100 p-4 rounded-xl group-hover:shadow-md transition-all duration-300 group-hover:border-red-100">
                            <div className="flex gap-3">
                              ...
                              <div className="flex-1">
                                <h3 className="text-base font-bold group-hover:text-red-600 transition-colors duration-200 mb-1 line-clamp-2">
                                  {post.title}
                                </h3>
                                ...
                                <div className="flex items-center text-xs text-zinc-500">
                                  ...
                                  <span className="font-medium">
                                    {(() => {
                                      // Use the WordPress standard of 275 words per minute
      ...
      {/* Latest Articles Section with Category Filtering - now showing ALL posts */}
      ...
      <section className="py-16 bg-zinc-900 text-white relative overflow-hidden">
        ...
        <div className="absolute -top-20 right-20 w-64 h-64 bg-red-600 rounded-full blur-3xl opacity-10"></div>

        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            <Badge className="bg-red-600 text-white mb-4">Stay Updated</Badge>
            <h2 className="text-3xl md:text-4xl font-bold mb-4">
              Subscribe to Our Newsletter
            </h2>
            <p className="text-zinc-300 mb-8 max-w-2xl mx-auto">
              Get the latest articles, news and insights about performance cars
              and modifications delivered directly to your inbox.
            </p>
