...
export const VehicleDetail = ({ vehicle }: VehicleDetailProps) => {
  ...
  useEffect(() => {
    if (typeof window === 'undefined') return
    setWhatsappUrl(`https://wa.me/447392615847?text=I'm interested in ${encodeURIComponent(vehicle.title)}. ${encodeURIComponent(window.location.href)}`)
  }, [vehicle.title])
      ...
      <div className="grid lg:grid-cols-2 gap-8 mb-12">
        ...
        <div>
          ...
          <div className="grid grid-cols-1 gap-4 mb-8 bg-zinc-900 p-6 rounded-lg">
            ...
            <div className="text-center text-white text-2xl font-bold mb-4">07392 615 847</div>
