...
interface ConsignmentIntroProps {
  title: string
...
export const ConsignmentIntro: React.FC<ConsignmentIntroProps> = ({
  title,
  content,
  image,
  imagePosition = 'right'
  ...
  // For debugging
  console.log("ConsignmentIntro image type:", typeof image);
  console.log("ConsignmentIntro image value:", image);
  
  let imageUrl = '/images/services/consignment-intro.jpg'
  ...
  console.log("ConsignmentIntro imageUrl after processing:", imageUrl);
        ...
        <div className={`flex flex-col ${isImageRight ? 'lg:flex-row' : 'lg:flex-row-reverse'} items-center gap-8 lg:gap-12`}>
          ...
          <div className="lg:w-1/2">
            <div className="relative aspect-video w-full overflow-hidden rounded-lg shadow-lg">
              <Image
                src={imageUrl}
                alt={(typeof image === 'object' && image.alt) ? image.alt : 'Consignment Car Sales Introduction'}
                fill
