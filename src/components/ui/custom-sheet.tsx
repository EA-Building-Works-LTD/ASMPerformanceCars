...
// Helper component for visually hidden elements
...
function CustomSheet({ ...props }: React.ComponentProps<typeof SheetPrimitive.Root>) {
  return <SheetPrimitive.Root data-slot="sheet" {...props} />
}

function CustomSheetTrigger({
  ...props
}: React.ComponentProps<typeof SheetPrimitive.Trigger>) {
  return <SheetPrimitive.Trigger data-slot="sheet-trigger" {...props} />
}

function CustomSheetClose({
  ...props
}: React.ComponentProps<typeof SheetPrimitive.Close>) {
  return <SheetPrimitive.Close data-slot="sheet-close" {...props} />
}

function CustomSheetPortal({
  ...props
}: React.ComponentProps<typeof SheetPrimitive.Portal>) {
  return <SheetPrimitive.Portal data-slot="sheet-portal" {...props} />
}

function CustomSheetOverlay({
  className,
  ...props
...
function CustomSheetHeader({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
...
function CustomSheetFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
...
function CustomSheetDescription({
  className,
  ...props
