...
export default {
      ...
      fields: [
        {
          ...
          fields: [
            ...
            },
            {
              ...
              title: 'Year',
              type: 'number',
              validation: (Rule: SanityRule) => Rule.required().min(1900).max(new Date().getFullYear()),
            },
            {
              name: 'transmission',
              title: 'Transmission',
            ...
            },
            {
              ...
              type: 'number',
              validation: (Rule: SanityRule) => Rule.min(1).max(5),
            },
            {
              name: 'status',
              title: 'Status',
  ...
  preview: {
    ...
    prepare({ title, media, subtitle, status }: PreviewParams) {
      return {
        title,
        media,
